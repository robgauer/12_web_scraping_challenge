...
* Example of utility MongoDB Compass displaying Document Collection.
![Mongo_Compass_Mars_db.png](Mongo_Compass_Mars_db.png "Example of utility MongoDB Compass displaying Document Collection")

* Example of browser session that the end user button selects to perform the 'Mars Update' data Web site scrape.
![Scrape_New_Data_index_html.png](Scrape_New_Data_index_html.png "Example Output")
